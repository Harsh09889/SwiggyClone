...
function Navbar() {
  ...
  useEffect(() => {
    ...
    // 		`https://maps.googleapis.com/maps/api/geocode/json?latlng=40.714224,-73.961452&key=AIzaSyBcnOt13n6jWPIaXmvgAw5dHfAqiR8yNlo`
    // 	);
    // 	console.log(result);
    // })();
    axios
  ...
  return (
    <div className="h-20 shadow-md flex justify-center sticky top-0 bg-white z-50">
      <div className="w-full h-full max-w-[1200px] px-4  flex items-center justify-between">
        ...
        <ul className="text-sm font-semibold mr-4 h-full flex items-center w-1/3 min-w-[28rem] justify-between">
          <li>
            <Link
              to="/search"
