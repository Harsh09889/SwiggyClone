      ...
      <div>
            ...
            <div className="transaction-details-container">
              ...
              <div className="transaction-details">
                ...
                <div className="transaction-detail">
                  <div>
                    <span>Total Amount</span> <span>INR {(currentCart?.cartItems.length > 1 &&
        ...
        <div className="ActionArea" id="OTPActionArea">
          ...
          <p>
            One Time Password (OTP) successfully sent to the phone number linked
            to your card ending with <strong>6726</strong>.
          </p>{" "}
          <form name="otpForm" id="otpForm" onSubmit={veryfyOtp}>
            <input
            onChange={(e)=>{
            ...
            required
            />{" "}
            <button type="submit" id="submit-action" className="user-action">
              <span>Submit</span>{" "}
